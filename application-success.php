...
<head>
    ...
    <title>Application Submitted - Gem and Jewellery Research and Training Institute</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-3xl mx-auto mt-10 bg-white shadow-lg rounded-xl p-8">
        <h1 class="text-2xl font-bold mb-6 text-blue-700">Application Submitted Successfully</h1>
        <div class="p-6 bg-green-50 border-l-4 border-green-500 rounded-lg mb-6">
            <p class="font-semibold text-green-700">Thank You!</p>
            <p class="text-gray-600 mt-2">Your application has been successfully submitted.</p>
            <p class="text-gray-600 mt-2">Reference Number: <strong><?php echo htmlspecialchars($reference_no); ?></strong></p>
            <p class="text-gray-600 mt-2">Please wait for admin approval. You will receive an email with payment instructions once your application is approved.</p>
        </div>
